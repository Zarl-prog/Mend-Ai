  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      ...
      <div className="flex-1 flex items-center justify-center">
        ...
        >
          <div className="w-24 h-24 bg-[#1a1a1a] border-2 border-dashed border-[#333] rounded-3xl flex items-center justify-center group-hover:border-[#6C47FF] group-hover:shadow-lg group-hover:shadow-purple-500/20 transition-all">
            <svg className="w-10 h-10 text-[#444] group-hover:text-[#6C47FF] transition-colors" viewBox="0 0 24 24" fill="none">
              <path d="M12 5v14M5 12h14" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>
          </div>
          <span className="text-white text-xl font-medium group-hover:text-[#6C47FF] transition-colors">New Project</span>
        </button>
      </div>
    </div>
  );
