...
export default function AIChatButton({ onClick, isOpen, isMobile = false }) {
  ...
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-gradient-to-br from-[#6C47FF] to-[#1D9E75] text-body flex items-center justify-center shadow-xl hover:scale-110 transition-transform z-[9999] animate-pulse-slow"
    >
